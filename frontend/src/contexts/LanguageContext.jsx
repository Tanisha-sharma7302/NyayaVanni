...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      'landing.chat.desc':
        'Ask general legal questions, explore your rights, and get instant answers based on Indian law.',
      ...
      'faq.a1':
        'You can upload PDF, Word document (.docx), PNG, and JPG files. For best results, use clear scans with readable text.',
      'faq.q2': 'Is my document stored permanently?',
      'faq.a2':
        'By default, documents are processed for analysis. If storage is enabled, you may see history features; otherwise, files are handled temporarily.',
      'faq.q3': 'Can I trust the output as legal advice?',
      'faq.a3':
        'NyayaVanni simplifies and explains. For critical decisions, consult a licensed lawyer.',
      'faq.q4': 'What if the upload fails?',
      'faq.a4':
        'Check your internet connection and try a smaller file. If the backend is offline, you’ll be redirected to a fallback demo.',
    },
    hi: {
      ...
      'faq.a2':
        'नहीं। यह सरल व्याख्या प्रदान करता है। महत्वपूर्ण निर्णयों के लिए वकील से सलाह लें।',
      'faq.q3': 'यह कैसे काम करता है?',
      'faq.a3':
        'हम टेक्स्ट निकालते हैं और AI की मदद से सारांश, जोखिम पहचान और प्रश्नों के उत्तर प्रदान करते हैं।',
      'faq.q4': 'क्या मेरा डेटा सुरक्षित है?',
      'faq.a4':
        'हम मानक सुरक्षा प्रक्रियाओं का पालन करते हैं, लेकिन कोई भी प्रणाली पूरी तरह जोखिम-मुक्त नहीं होती।',
    },
  };
