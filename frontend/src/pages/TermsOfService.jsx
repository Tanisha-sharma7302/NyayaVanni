          ...
          <div className="mt-8 space-y-6 text-slate-700 dark:text-slate-350 leading-relaxed">
            <section className="bg-white dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
              ...
              <p className="mt-2 text-sm">
                NyayaVanni provides simplified explanations. Always consult a
            ...
            <section className="bg-white dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
              ...
              <p className="mt-2 text-sm">
                You are responsible for the documents you upload and ensuring
                you have rights to share them.
              </p>
            </section>
            ...
            <section className="bg-white dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
              ...
              <p className="mt-2 text-sm">
                The service may be updated, paused, or changed without prior
                notice.
              </p>
            </section>
            ...
            <section className="bg-white dark:bg-slate-900/40 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
              ...
              <p className="mt-2 text-sm">
                Email:{' '}
                <span className="text-nyaya-600 dark:text-nyaya-400 font-semibold">
